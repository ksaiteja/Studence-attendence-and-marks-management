...
<body>
    ...
    <div id="login_box">
        <form action="login.php" method="post">
            ...
            <h8 style="padding-top: 10px; display:inline-block;">Don't have an account? <a href="sign-up.php"
                    style="text-decoration: none; color:blue;font-size:medium;">SIGNUP</a></h8>
        </form>
    </div>
</body>
